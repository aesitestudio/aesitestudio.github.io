...
\r
        <div class="pt-page-off state-dayend bombintern-page">\r
            <div class="container">\r
                ...
                <form class="pure-form">\r
                    <button type="button" id="bombintern-nextday" class="button-bombintern button-xlarge pure-button pure-input-1">СЛЕД. ДЕНЬ</button>\r
                    <button type="button" id="bombintern-retryday" class="button-bombintern button-xlarge pure-button pure-input-1">ПЕРЕПРОЙТИ ДЕНЬ</button>\r
...
\r
        <div class="pt-page-off state-gameover bombintern-page">\r
            <div class="container">\r
                ...
                <form class="pure-form">\r
                    <button type="button" id="bombintern-retry" class="button-bombintern button-xlarge pure-button pure-input-1">ЗАНОВО</button>\r
        ...
        switch (Ae(".bombintern-page").css("background-color", v), n) {
            case "Lobby":
                switch (this.$el.find("#bombintern-startgame").hide(), this.$el.find("#bombintern-stopcountdown").hide(), a) {
                    case "WaitingForMore":
                        this.$el.find("#bombintern-lobby-text").html("Ждём других игроков"), this.showScreen(".state-lobby");
                        break;
                    case "CanStart":
                        this.$el.find("#bombintern-lobby-text").html("Нажми эту кнопку когда все будут готовы"), this.$el.find("#bombintern-startgame").show(), this.showScreen(".state-lobby");
                        break;
                    case "Countdown":
